...
const navItems: NavItem[] = [
  ...
  {
    label: "Pricing",
    children: [{ label: "View Pricing", href: "/pricing" }],
  },
  {
    label: "How It Works",
...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav
        ref={navRef}
        className={`fixed hidden md:block  top-0 left-0 right-0 z-50 transition-all duration-300 ease-out ${
      ...
      <div
        className={`md:hidden fixed top-0 left-0 right-0 z-50 px-7 py-5 flex items-center justify-between transition-all duration-300 ${
          scrolled
